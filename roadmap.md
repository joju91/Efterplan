...
| T122 | Tokenisera hårdkodade hex-färger i inline `style=`: dodsannons.html (2 callout-divs → .seo-callout), vad-gora-nar-nagon-dor.html (8 table-td → CSS-regel). Inga fler inline hex-färger kvar (0 träffar grep). .seo-callout + .seo-article table tbody td tillagda i style.css. | 2026-05-30 | Fas 12 | Dagsrapport | 🟡 | Design | ✔ |
| T123 | De-inlining: utility-klasser (.u-*) tillagda i style.css och applicerade på auth-modal.html + vad-gora-nar-nagon-dor.html. ~50 nya utility-klasser. Inline hex-färger eliminerade (T122). Inga ytterligare inline style= med hårdkodade värden kvarstår. | 2026-05-30 | Fas 12 | Dagsrapport | 🟢 | Dev | ✔ |
...
| T127 | SEO-sida: livforsakring-dodsfall.html — "Livförsäkring vid dödsfall: hur du ansöker om ersättning". FAQ-schema, intern länkning. | 2026-05-30 | Fas 12 | SEO Sprint | 🟠 | SEO | ✔ |
| T128 | SEO-sida: vardepapper-dodsfall.html — "Aktier och fonder i dödsbo: steg för steg". FAQ-schema, intern länkning. | 2026-05-30 | Fas 12 | SEO Sprint | 🟠 | SEO | ✔ |
| T129 | SEO-sida: barnpension-guide.html — "Barnpension: vem får det och hur ansöker man?". FAQ-schema, intern länkning. | 2026-05-30 | Fas 12 | SEO Sprint | 🟠 | SEO | ✔ |
| T130 | SEO-sida: omstallningspension-guide.html — "Omställningspension: din rätt när maken eller makan dör". FAQ-schema, intern länkning. | 2026-05-30 | Fas 12 | SEO Sprint | 🟠 | SEO | ✔ |
| T131 | Bouppteckning PDF-export: "Spara som PDF"-knapp i bouppteckning-tabben (window.print() + body.print-bopp CSS-klass). @media print visar bara bouppteckning-innehållet. | 2026-05-30 | Fas 12 | Session | 🟠 | Dev | ✔ |
| BugFix | OB_TOTAL 3→4: progressbaren i onboarding visade fel antal steg (HTML hade 4 steg, OB_TOTAL=3). Rättat i app.js rad 180. | 2026-05-30 | Fas 12 | Bugfix | 🔴 | Dev | ✔ |
